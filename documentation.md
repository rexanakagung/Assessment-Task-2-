...
Game Interface:![alt text](<Screenshot 2026-06-19 at 4.46.41 am.png>)

Storyboard: ![alt text](<Screenshot 2026-06-19 at 4.47.02 am.png>)
            ![alt text](<Screenshot 2026-06-19 at 4.47.16 am.png>)
            ![alt text](<Screenshot 2026-06-19 at 4.47.26 am.png>)
            ![alt text](<Screenshot 2026-06-19 at 4.47.36 am.png>)
            ![alt text](<Screenshot 2026-06-19 at 4.47.50 am.png>)

# Part F — Social, Ethical and Legal Implications
One way in which this game has the potential to influence the perceptions of the participants is in a subtle manner where they begin to develop their own perception of what makes cars valuable. Most people decide on what cars to purchase based on cost of operation, durability, and efficiency in addition to the level of safety. In this game none of these factors are incorporated and the winner begins to perceive that the winning attributes such as horse power and maximum speed are the deciding ones.
There is also a high probability of introducing a bias towards high cost and high performing cars. For example, a Lamborghini Huracan will perform better than a 2012 Mazda 3 on almost every aspect included in this deck. This is a biased view of what makes a car a worthy one and introduces a perception that performance and wealth are synonymous. I am supposed to ensure that the information provided is accurate and comes directly from carsales.com.au without any manipulation that favors the supercars. One practical solution to this problem is adding another attribute that allows everyday cars to have a chance.

When considering these attributes as a whole, speed, horsepower, acceleration, engine size, braking distance and year, they overwhelmingly favor sports cars and luxury models. This is a significant bias because it promotes the belief that status and wealth are defined by the performance capabilities of a vehicle, and that new, fast and expensive necessarily implies being better. The player with a second hand Corolla will see their cars lose over and over again, something which may seem like a minor thing but indicates a conscious choice to privilege one type of car owner at the expense of all others.
This game also requires a certain degree of knowledge of car culture that leans towards a specific demographic. In order to be a more inclusive game, the deck must include the actual spectrum of vehicles Australians own including hatchbacks, utility vehicles, family wagons and even electric cars, and include attributes such as fuel economy, safety stars, cargo space or costs per kilometre.

Certainly, this is one of the main problems with the current design. A huge engine of 5.2 liter V10 valued highly by the game implies that larger engines are better. Speed and acceleration that have been attributed the top ratings in this game encourage driving in a manner that maximizes gasoline consumption and carbon dioxide emissions. The current design of the game does not care about the environmental performance of the car at all, which is truly problematic when it comes to a young audience which is yet to develop its attitude to owning cars and global warming.
The problem is very easy to solve, though. All you need is to add fuel efficiency and CO2 emission attributes with low values of those attributes being rated highly. It will not influence the operation of the game, but will prove that the environmental performance is one of the real criteria to evaluate a car. This is true in reality as well, since the Australian car market moves to electric cars, particularly the ones sold through carsales.com.au. 

Using real world car data from carsales.com.au is reasonable for an educational project but it does come with responsibilities worth taking seriously. The individual facts, a car's horsepower, its top speed, are not copyrightable on their own, but the way carsales compiles, structures and presents that data as a database may be protected, and reproducing it without acknowledgment could breach their terms of service.
Accuracy is another genuine concern. Car specifications vary significantly depending on variant, year and market. The Lamborghini Huracan EVO alone has multiple versions with different power outputs. Displaying a single figure without specifying which variant it comes from could mislead users, and in a commercial context that kind of imprecision could create issues under Australian Consumer Law around misleading and deceptive conduct.
For this project the right approach is to clearly cite carsales.com.au as the data source on every card, specify the exact variant the figures apply to, and include a short disclaimer that the values are approximate and used for educational purposes. No carsales branding, imagery or proprietary content should be reproduced. It is a school project so the legal risk is minimal, but treating sourcing and accuracy seriously is just good design practice regardless.